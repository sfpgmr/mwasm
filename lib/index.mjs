  ...
  try {
    ...
    class Context {
            ...
            case 'MemoryMap':
              {
                ...
                this.defineMember(token.defines, this.context,{preprocessed:preprocessed});
              }
              break;
            default:
      ...
      defineMember(defines, currentContext, opts) {
        let offset = 0;
        const rootContext = this.context;
        const structDefinition = opts && opts.structName;
      ...
      makeInitDataString(def,structDefinition){}
    }
