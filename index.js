...
var peg$c39 = "{@endif";
var peg$c40 = "{@include";
var peg$c41 = "{@macro_def";
var peg$c42 = "{@end_macro_def";
var peg$c43 = "{@@";
var peg$c44 = "{@map";
var peg$c45 = "=";
var peg$c46 = "offset";
...
var peg$r27 = /^[\u01C5\u01C8\u01CB\u01F2\u1F88-\u1F8F\u1F98-\u1F9F\u1FA8-\u1FAF\u1FBC\u1FCC\u1FFC]/;
var peg$r28 = /^[A-Z\xC0-\xD6\xD8-\xDE\u0100\u0102\u0104\u0106\u0108\u010A\u010C\u010E\u0110\u0112\u0114\u0116\u0118\u011A\u011C\u011E\u0120\u0122\u0124\u0126\u0128\u012A\u012C\u012E\u0130\u0132\u0134\u0136\u0139\u013B\u013D\u013F\u0141\u0143\u0145\u0147\u014A\u014C\u014E\u0150\u0152\u0154\u0156\u0158\u015A\u015C\u015E\u0160\u0162\u0164\u0166\u0168\u016A\u016C\u016E\u0170\u0172\u0174\u0176\u0178-\u0179\u017B\u017D\u0181-\u0182\u0184\u0186-\u0187\u0189-\u018B\u018E-\u0191\u0193-\u0194\u0196-\u0198\u019C-\u019D\u019F-\u01A0\u01A2\u01A4\u01A6-\u01A7\u01A9\u01AC\u01AE-\u01AF\u01B1-\u01B3\u01B5\u01B7-\u01B8\u01BC\u01C4\u01C7\u01CA\u01CD\u01CF\u01D1\u01D3\u01D5\u01D7\u01D9\u01DB\u01DE\u01E0\u01E2\u01E4\u01E6\u01E8\u01EA\u01EC\u01EE\u01F1\u01F4\u01F6-\u01F8\u01FA\u01FC\u01FE\u0200\u0202\u0204\u0206\u0208\u020A\u020C\u020E\u0210\u0212\u0214\u0216\u0218\u021A\u021C\u021E\u0220\u0222\u0224\u0226\u0228\u022A\u022C\u022E\u0230\u0232\u023A-\u023B\u023D-\u023E\u0241\u0243-\u0246\u0248\u024A\u024C\u024E\u0370\u0372\u0376\u037F\u0386\u0388-\u038A\u038C\u038E-\u038F\u0391-\u03A1\u03A3-\u03AB\u03CF\u03D2-\u03D4\u03D8\u03DA\u03DC\u03DE\u03E0\u03E2\u03E4\u03E6\u03E8\u03EA\u03EC\u03EE\u03F4\u03F7\u03F9-\u03FA\u03FD-\u042F\u0460\u0462\u0464\u0466\u0468\u046A\u046C\u046E\u0470\u0472\u0474\u0476\u0478\u047A\u047C\u047E\u0480\u048A\u048C\u048E\u0490\u0492\u0494\u0496\u0498\u049A\u049C\u049E\u04A0\u04A2\u04A4\u04A6\u04A8\u04AA\u04AC\u04AE\u04B0\u04B2\u04B4\u04B6\u04B8\u04BA\u04BC\u04BE\u04C0-\u04C1\u04C3\u04C5\u04C7\u04C9\u04CB\u04CD\u04D0\u04D2\u04D4\u04D6\u04D8\u04DA\u04DC\u04DE\u04E0\u04E2\u04E4\u04E6\u04E8\u04EA\u04EC\u04EE\u04F0\u04F2\u04F4\u04F6\u04F8\u04FA\u04FC\u04FE\u0500\u0502\u0504\u0506\u0508\u050A\u050C\u050E\u0510\u0512\u0514\u0516\u0518\u051A\u051C\u051E\u0520\u0522\u0524\u0526\u0528\u052A\u052C\u052E\u0531-\u0556\u10A0-\u10C5\u10C7\u10CD\u13A0-\u13F5\u1C90-\u1CBA\u1CBD-\u1CBF\u1E00\u1E02\u1E04\u1E06\
uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9E5\uAA29-\uAA2E\uAA31-\uAA32\uAA35-\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7-\uAAB8\uAABE-\uAABF\uAAC1\uAAEC-\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F]/;
var peg$r31 = /^[0-9\u0660-\u0669\u06F0-\u06F9\u07C0-\u07C9\u0966-\u096F\u09E6-\u09EF\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0BE6-\u0BEF\u0C66-\u0C6F\u0CE6-\u0CEF\u0D66-\u0D6F\u0DE6-\u0DEF\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F29\u1040-\u1049\u1090-\u1099\u17E0-\u17E9\u1810-\u1819\u1946-\u194F\u19D0-\u19D9\u1A80-\u1A89\u1A90-\u1A99\u1B50-\u1B59\u1BB0-\u1BB9\u1C40-\u1C49\u1C50-\u1C59\uA620-\uA629\uA8D0-\uA8D9\uA900-\uA909\uA9D0-\uA9D9\uA9F0-\uA9F9\uAA50-\uAA59\uABF0-\uABF9\uFF10-\uFF19]/;
var peg$r32 = /^[\u16EE-\u16F0\u2160-\u2182\u2185-\u2188\u3007\u3021-\u3029\u3038-\u303A\uA6E6-\uA6EF]/;
var peg$r33 = /^[_\u203F-\u2040\u2054\uFE33-\uFE34\uFE4D-\uFE4F\uFF3F]/;
var peg$r34 = /^[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;

var peg$e0 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], "!", "#", "$", "%", "&", "'", "*", ["+", "."], "\\", ":", "<", "=", ">", "?", "@", "^", "_", "`", "~", "!"], false, false);
  ...
  var peg$e16 = peg$otherExpectation("Preprocessor");

  var peg$f0 = function(tokens) {
   return tokens;
  };
  var peg$f1 = function(space) {
       return node('WhiteSpace',{value:space.join('')});
    };
  var peg$f2 = function(id) {return node('Identifier',{name:id});};
  var peg$f3 = function() {return node('Parenthesis',{kind:text()});};
  var peg$f4 = function() {return node('StringLiteral',{value:text()})};
  var peg$f5 = function() {return node('Comment',{value:text()})};
  var peg$f6 = function(prefix, code) {
      if(prefix == ".") code = "$." + code;
      return node('CodeExpression',{code:code});
      };
  var peg$f7 = function(code) {return node('CodeWithoutReturnValue',{code:code});};
  var peg$f8 = function(code) {return node('Code',{code:code});};
  var peg$f9 = function() { error("Unbalanced brace."); };
  var peg$f10 = function() {return node("JSOperator",{value:text()});};
  var peg$f11 = function() {return node("JSNumber",{value:text()});};
  var peg$f12 = function(n) {return n};
  var peg$f13 = function(sign, value) { return node('IntegerLiteral',{sign:sign?sign:'+',value:value});};
  var peg$f14 = function(sign, value) { return node('BinaryIntegerLiteral',{sign:sign?sign:'+',value:value});};
  var peg$f15 = function(sign, value) { return node('OctalIntegerLiteral',{sign:sign?sign:'+',value:value});};
  var peg$f16 = function(sign, value) { return node('HexIntegerLiteral',{sign:sign?sign:'+',value:value});};
  var peg$f17 = function(sign, number, flac) {return {number:number,flac:flac}};
  var peg$f18 = function(sign, flac) {return {number:0,flac:flac}};
  var peg$f19 = function(sign, number) {return {number:number,flac:0}};
  var peg$f20 = function(sign, number, expsign, e) {return {expsign:expsign,e:e};};
  var peg$f21 = function(sign, number, exponential) {
      return node('FloatLiteral',Object.assign({sign:sign?sign:'+'},number,exponential?exponential:{}));
    };
  var peg$f22 = function(sign, flac) {return {number:0,flac:0}};
  var peg$f23 = function(sign, number, exponential) {
      return node('HexFloatLiteral',Object.assign({sign:sign?sign:'+'},number,exponential));
    };
  var peg$f24 = function(sign, number, exponential) {
      return node('BinaryFloatLiteral',Object.assign({sign:sign?sign:'+'},number,exponential));
    };
  var peg$f25 = function(jsstring) { return node("JSString",{value:jsstring }); };
  var peg$f27 = function(head, tail) {
    return node("MwasmArray",{value:buildList(head,tail,3)});
  };
  var peg$f28 = function() {return node("WhiteSpace",{value:text()});};
  var peg$f29 = function(prefix, name) {return node("JSPropertyName",{name:name,prefix:prefix}); };
  var peg$f30 = function(head, id) { return id;};
  var peg$f31 = function(head, ex) {return node("IndexExpression",{expression:ex.expression});};
  ...
  var peg$f33 = function(prop) {
    return prop;
  };
  var peg$f34 = function(prop) {
    prop.type = "ValueExpression";
    return prop;
  };
  var peg$f35 = function(ex) {
    return node("PropertyExpression",{expression:ex} );
  };
  var peg$f36 = function(expression, ifTokens, elseTokens_) {
    let elseTokens = elseTokens_;
    if(elseTokens && elseTokens.length) {
      elseTokens = elseTokens[1];
      if(elseTokens && elseTokens.length){
        elseTokens = normalize(extractList(elseTokens,1));
      } else {
        elseTokens = null;
      }
    } else {
    ...
    return node('Condition',{
      ...
      if:(ifTokens && ifTokens.length) ? normalize(extractList(ifTokens,2)) : null,
      else:elseTokens
    });
  };
  var peg$f37 = function() {return node('Else')};
  var peg$f38 = function() {return node('EndIf')};
  var peg$f39 = function(pathExpression) {
    return node('SourceInclude',{ pathExpression: pathExpression });
  };
  var peg$f40 = function(head, tail) {
    return node("MacroParams",{value:buildList(head,tail,3)});
  };
  var peg$f41 = function(macroName, macroParams, macroBody) {
    return node('MacroDefinition',
      {
        macroName:macroName,
  ...
  var peg$f42 = function() {
    return node('MacroEnd');
  };
  var peg$f43 = function(id) {return node('Identifier',{name:id})};
  var peg$f44 = function(token) {return token[1];};
  var peg$f45 = function(head, tail) {
    return node("MacroParams",{params:buildList(head,tail,3)});
  };
  var peg$f46 = function(macroName, macroParams) {
    return node('MacroExecution',
    {
      macroName:macroName,
      macroParams:macroParams
    });
  };
  var peg$f47 = function(defines) {
    return node('MemoryMap',{defines:nomalizeDefines(defines)});
  };
  var peg$f48 = function(type, head, tail) { return buildList(head,tail,3);};
  var peg$f49 = function(type, id, data) {return data;};
  var peg$f50 = function(type, id, initData) {
    return node('MemoryLabel',{id:id,varType:type,initData:initData});
  };
  var peg$f51 = function(offset) {
    return node('Offset',{offset:offset});
  };
  var peg$f52 = function(id, numExpression) {return numExpression;};
  var peg$f53 = function(id, numExpression) {return node("MemoryLabelId",{id:id,numExpression:numExpression})};
  var peg$f54 = function(num) {return num;};
  var peg$f55 = function() {return node('PrimitiveType',{varType:'i32',size:4,integer:true,unsigned:false});};
  var peg$f56 = function() {return node('PrimitiveType',{varType:'i64',size:8,integer:true,unsigned:false});};
  var peg$f57 = function() {return node('PrimitiveType',{varType:'f32',size:4,integer:false,unsigned:false});};
  var peg$f58 = function() {return node('PrimitiveType',{varType:'f64',size:8,integer:false,unsigned:false});};
  var peg$f59 = function(id, defines) {
  ...
  function peg$parsestart() {
    ...
    s0 = peg$parseNormalizedTokens();

    return s0;
  }

  function peg$parseNormalizedTokens() {
    var s0, s1, s2;
  ...
  function peg$parsePreprocessor() {
    ...
    peg$silentFails++;
    s0 = peg$parseSourceInclude();
    if (s0 === peg$FAILED) {
      s0 = peg$parseCondition();
      if (s0 === peg$FAILED) {
        s0 = peg$parseMacroDefinition();
        if (s0 === peg$FAILED) {
          s0 = peg$parseMacroExecution();
          if (s0 === peg$FAILED) {
            s0 = peg$parseMemoryMap();
            if (s0 === peg$FAILED) {
  ...
  function peg$parseMwasmNumericLiteral() {
    var s0;
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          ...
          if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
              s0 = peg$parseBinaryFloatLiteral();
              if (s0 === peg$FAILED) {
                s0 = peg$parseHexFloatLiteral();
              }
            }
          }
        }
  ...
  function peg$parseHexFloatLiteral() {
  ...
  function peg$parseBinaryFloatLiteral() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
  ...
  function peg$parseJSStatement() {
    ...
    s0 = peg$parseJSString();
    if (s0 === peg$FAILED) {
      s0 = peg$parseJSOperator();
      if (s0 === peg$FAILED) {
        s0 = peg$parseJSNumber();
        if (s0 === peg$FAILED) {
          s0 = peg$currPos;
          s1 = peg$currPos;
          s2 = [];
  ...
  function peg$parseJSPropertyName() {
    var s0, s1, s2;
  ...
  function peg$parseSourceInclude() {
    var s0, s1, s2, s3, s5;
  ...
  function peg$parseMacroSeparator() {
    var s0, s1;
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          ...
          if (s0 === peg$FAILED) {
            s0 = peg$parseMacroIdentifier();
            if (s0 === peg$FAILED) {
              s0 = peg$parseMacroSeparator();
              if (s0 === peg$FAILED) {
                s0 = peg$parseParenthesis();
                if (s0 === peg$FAILED) {
                  s0 = peg$parse__$();
  ...
  function peg$parseMacroParamsExpression() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8;

    s0 = peg$currPos;
    s1 = [];
    s2 = peg$parseMacroToken();
    while (s2 !== peg$FAILED) {
      s1.push(s2);
      s2 = peg$parseMacroToken();
    }
  ...
  function peg$parseMacroExecution() {
    var s0, s1, s2, s4, s6;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        peg$parse__();
        s4 = peg$parseMacroParamsExpression();
        peg$parse__();
        if (input.charCodeAt(peg$currPos) === 125) {
          s6 = peg$c21;
          peg$currPos++;
  ...
  function peg$parseSourceCharacterWithoutLineTerminator() {
    var s0;
  ...
  function peg$parseCodeLine() {
    ...
    if (s4 !== peg$FAILED) {
      s5 = peg$parseSourceCharacterWithoutLineTerminator();
      if (s5 !== peg$FAILED) {
        s4 = [s4, s5];
        s3 = s4;
      } else {
  ...
  function peg$parseMemoryLabel() {
    var s0, s1, s3, s4, s5, s6, s7, s8, s9, s10;

    s0 = peg$currPos;
    s1 = peg$parseNativeValTypes();
    if (s1 === peg$FAILED) {
      s1 = peg$parseStruct();
    }
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s6 !== peg$FAILED) {
          s7 = peg$parse__();
          s8 = peg$parseMwasmArray();
          if (s8 === peg$FAILED) {
            s8 = peg$parseMwasmNumericLiteral();
            if (s8 === peg$FAILED) {
              s8 = peg$parseJSString();
              if (s8 === peg$FAILED) {
                s8 = peg$parseJSCodes();
              }
            }
  ...
  function peg$parseMemoryLabelId() {
    var s0, s1, s2, s4;
  ...
  function peg$parseNativeValTypes() {
    var s0;
  ...
  function peg$parseStructDefinition() {
    var s0, s1, s3, s5, s6;
  ...
  function peg$parseZs() {
    ...
    function node(type,opt={}){
      let obj = new Node(type);
      if(opt){
        return Object.assign(obj,opt,location());
      } else {
        return obj;
      }
    }
    ...
    function normalize(tokens){
      return tokens.filter(d=>(d && d.type != 'Skip' && d.type != "Comment"));
    }
      ...
      makeDataString(def, offset) {
        ...
        function makeDataString_(data, varType, def) {
          ...
          switch (data.type) {
                ...
                function makeDataStringFromStruct(data, structDefinition) {
                  ...
                  for (const p in structDefinition) {
                    if (p != $attributes) {
                      ...
                      //console.log(data,structDefinition,memberDefinition);
                      if (i >= data.length) {
                        currentOffset += memberDefinition.size * memberDefinition.num;
                      } else {
                        if (memberDefinition.type == 'StructDefinition') {
                          //console.log(p + ' != $attributes:', structDefinition[p], memberDefinition,data[i]);
                          makeDataStringFromStruct(data[i++].value,structDefinition[p]);
                        } else {
                          //console.log('not struct',data,data[i],memberDefinition,i);
            ...
            case 'BinaryIntegerLiteral':
              if (varType.varType == 'i32' || varType.varType == 'i64') {
                result.dataString += lib.binaryIntegerStrToDataStr(data.value, data.sign);
              } else {
                error(`type missmatch  ${varType.varType} != ${data.type}`, def);
              }
              break;
            case 'OctalIntegerLiteral':
              if (varType.varType == 'i32' || varType.varType == 'i64') {
                result.dataString += lib.octalIntegerStrToDataStr(data.value, data.sign);
              } else {
                error(`type missmatch  ${varType.varType} != ${data.type}`, def);
              }
              break;
