...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c100 = function() {return node("WhiteSpace",{value:text()});},
      peg$c101 = /^[&#]/,
      peg$c102 = peg$classExpectation(["&", "#"], false, false),
      peg$c103 = function(prefix, name) {return node("JSPropertyName",{name:name,prefix:prefix}); },
      peg$c104 = function(head, id) { return id;},
      peg$c105 = function(head, ex) {return node("IndexExpression",{expression:ex.expression});},
      ...
      peg$c111 = function(prop) {
        return prop;
      },
      peg$c112 = function(ex) {
        return node("PropertyExpression",{expression:ex} );
      },
      peg$c113 = peg$otherExpectation("Condition"),
      peg$c114 = "{@if",
      peg$c115 = peg$literalExpectation("{@if", false),
      peg$c116 = function(expression, ifTokens, elseTokens_) {
      ...
      peg$c117 = peg$otherExpectation("else"),
      peg$c118 = "{@else",
      peg$c119 = peg$literalExpectation("{@else", false),
      peg$c120 = function() {return node('Else')},
      peg$c121 = peg$otherExpectation("endif"),
      peg$c122 = "{@endif",
      peg$c123 = peg$literalExpectation("{@endif", false),
      peg$c124 = function() {return node('EndIf')},
      peg$c125 = peg$otherExpectation("source include"),
      peg$c126 = "{@include",
      peg$c127 = peg$literalExpectation("{@include", false),
      peg$c128 = function(pathExpression) {
      ...
      peg$c133 = "{@map",
      peg$c134 = peg$literalExpectation("{@map", false),
      peg$c135 = function(defines) {
        return node('MemoryMap',{defines:nomalizeDefines(defines)});
      },
      peg$c136 = function(type, head, tail) { return buildList(head,tail,3);},
      peg$c137 = function(type, id, data) {return data;},
      peg$c138 = function(type, id, initData) {
        return node('MemoryLabel',{id:id,varType:type,initData:initData});
      },
      peg$c139 = "offset",
      peg$c140 = peg$literalExpectation("offset", false),
      peg$c141 = function(offset) {return offset;},
      peg$c142 = function(offset) {
        return node('Offset',{offset:offset});
      },
      peg$c143 = function(id, numExpression) {return numExpression;},
      peg$c144 = function(id, numExpression) {return node("MemoryLabelId",{id:id,numExpression:numExpression})},
      peg$c145 = /^[[\]]/,
      peg$c146 = peg$classExpectation(["[", "]"], false, false),
      peg$c147 = "i32",
      peg$c148 = peg$literalExpectation("i32", false),
      peg$c149 = function() {return node('PrimitiveType',{varType:'i32',size:4,integer:true,unsigned:false});},
      peg$c150 = "i64",
      peg$c151 = peg$literalExpectation("i64", false),
      peg$c152 = function() {return node('PrimitiveType',{varType:'i64',size:8,integer:true,unsigned:false});},
      peg$c153 = "u32",
      peg$c154 = peg$literalExpectation("u32", false),
      peg$c155 = function() {return node('PrimitiveType',{varType:'u32',size:4,integer:true,unsigned:true});},
      peg$c156 = "u64",
      peg$c157 = peg$literalExpectation("u64", false),
      peg$c158 = function() {return node('PrimitiveType',{varType:'u64',size:8,integer:true,unsigned:true});},
      peg$c159 = "f32",
      peg$c160 = peg$literalExpectation("f32", false),
      peg$c161 = function() {return node('PrimitiveType',{varType:'f32',size:4,integer:false,unsigned:false});},
      peg$c162 = "f64",
      peg$c163 = peg$literalExpectation("f64", false),
      peg$c164 = function() {return node('PrimitiveType',{varType:'f64',size:8,integer:false,unsigned:false});},
      peg$c165 = "{@struct",
      peg$c166 = peg$literalExpectation("{@struct", false),
      peg$c167 = function(id, defines) {
      ...
      peg$c169 = peg$otherExpectation("JavaScript Identifier"),
      ...
      peg$c183 = /^[0-9a-f]/i,
      peg$c184 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true),
